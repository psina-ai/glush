namespace Glush.GameFlags
{
    ...
    public static class GameFlagKeys
    {
        ...
        // ═══════════════════════════════════════════════════════
        // Расходуемые ресурсы (целые числа)
        // ═══════════════════════════════════════════════════════

        /// <summary>Сколько сигарет у Алексея сейчас (покупка +5, курение -1)</summary>
        public const string CigarettesCount = "cigarettes_count";
